...
function ExerciseScreen({ route, navigation }) {
  ...
  let { suggestedKey } = route.params
  let gotoExercise = useCallback(() => {
    navigation.push("RepetitionExercise", {  suggested: suggestedKey, exerciseList: exerciseList, exerciseKey: "2", count: route.params.count + 1})
  })
